                          ...
                          <div className="flex items-center">
                            ...
                            {item.isNew && (
                              <div className={cn(
                                ...
                                item.isEmerald ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300" : "bg-violet-100 text-violet-700 dark:bg-violet-950 dark:text-violet-300"
                              )}>
                                New
                              </div>
                            )}
